...
{
    public class ActiveXConnect86API : IActiveXConnectAPI
    {
        private readonly IActiveXConnect86API _api;

        public ActiveXConnect86API()
        {
            _api = (IActiveXConnect86API)Activator.CreateInstance(Marshal.GetTypeFromCLSID(new Guid("C35EE0FC-6F7A-40E8-81DD-B7C2E808D2C2")));
        }
