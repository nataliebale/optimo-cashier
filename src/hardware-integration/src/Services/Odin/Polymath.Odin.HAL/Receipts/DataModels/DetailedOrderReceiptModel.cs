...
{
    public class DetailedOrderReceiptModel : IReceiptModel
    {
        public DetailedOrderReceiptModel()
        {
        }

        public DetailedOrderReceiptModel(OdingSettings settings, Order order)
        {
