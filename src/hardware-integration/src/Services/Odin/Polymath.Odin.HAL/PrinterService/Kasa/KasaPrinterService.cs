...
namespace Polymath.Odin.HAL.PrinterService.Kasa
{
    public class KasaPrinterService : PrinterService
    {
        public KasaPrinterService(ICashierService cashierService) : base(cashierService)
        {
        }
