...
export class update1588261875685 implements MigrationInterface {
    name = 'update1588261875685'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_table" ("id" integer PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "status" integer NOT NULL, "spaceId" integer, CONSTRAINT "FK_83c86167f8ee80974f35e546474" FOREIGN KEY ("spaceId") REFERENCES "space" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "table" ("id" integer PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "status" integer NOT NULL, "tableStatus" integer, "numberOfGuests" integer, "spaceId" integer, CONSTRAINT "FK_83c86167f8ee80974f35e546474" FOREIGN KEY ("spaceId") REFERENCES "space" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
