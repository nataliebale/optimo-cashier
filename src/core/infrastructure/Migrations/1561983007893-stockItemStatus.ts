...
export class stockItemStatus1561983007893 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_stock_item"("id", "photoUrl", "photoPath", "barcode", "name", "quantity", "unitPrice", "categoryId", "soldQuantity") SELECT "id", "photoUrl", "photoPath", "barcode", "name", "quantity", "unitPrice", "categoryId", "soldQuantity" FROM "stock_item"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`INSERT INTO "stock_item"("id", "photoUrl", "photoPath", "barcode", "name", "quantity", "unitPrice", "categoryId", "soldQuantity") SELECT "id", "photoUrl", "photoPath", "barcode", "name", "quantity", "unitPrice", "categoryId", "soldQuantity" FROM "temporary_stock_item"`);
