...
export class addedBasketDeletionPermission1575366070553 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_operator" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "pinCode" varchar NOT NULL, "status" integer NOT NULL, "canReceivePurchaseOrders" boolean DEFAULT (1), "canSetDiscount" boolean NOT NULL DEFAULT (1), "canChangePrice" boolean NOT NULL DEFAULT (1), "canDeleteFromBasket" boolean NOT NULL DEFAULT (1), "canDeleteBasket" boolean NOT NULL DEFAULT (1))`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "operator" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "pinCode" varchar NOT NULL, "status" integer NOT NULL, "canReceivePurchaseOrders" boolean DEFAULT (1), "canSetDiscount" boolean NOT NULL DEFAULT (1), "canChangePrice" boolean NOT NULL DEFAULT (1), "canDeleteFromBasket" boolean NOT NULL DEFAULT (1))`, undefined);
